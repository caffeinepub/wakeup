        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Manage your pharmacist profile and resume
            </p>
          </div>
        </div>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 rounded-full bg-primary/20 flex items-center justify-center text-primary font-display font-bold text-xl shrink-0">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3 mt-2 text-sm text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {Number(candidate.yearsOfExperience)} yrs exp
                        </span>
                        <span className="flex items-center gap-1">
                  ...
                  <div className="flex items-center gap-3 sm:flex-col sm:items-end">
                    ...
                    <Badge
                      variant={
                        candidate.isProfileActive ? "default" : "secondary"
                      }
                      className={
                        candidate.isProfileActive
