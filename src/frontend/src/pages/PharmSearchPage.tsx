      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3 mb-1">
            ...
            <Badge className="bg-navy-400 text-white border-0 text-xs">
              Candidate Database
            </Badge>
          </div>
          <p className="text-muted-foreground text-sm">
            Search and source verified pharmacist profiles using keywords and
            filters.
          </p>
        </div>
