      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Manage job postings and search for pharmacy talent
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 rounded-xl bg-primary/20 flex items-center justify-center text-primary font-display font-bold text-xl shrink-0">
                ...
                <Card className="shadow-card border-border">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                      Search and source from thousands of verified pharmacist
                      profiles using keywords and filters.
                    </p>
                    <Button
