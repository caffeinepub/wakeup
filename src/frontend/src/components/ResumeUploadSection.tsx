...
import { CheckCircle, File, FileText, Loader2, Upload } from "lucide-react";
  ...
  return (
    <Card className="shadow-card border-border">
      <CardContent className="p-6">
        ...
        <button
          type="button"
          className="w-full border-2 border-dashed border-border rounded-xl p-8 text-center cursor-pointer hover:border-primary hover:bg-secondary/50 transition-colors bg-transparent"
