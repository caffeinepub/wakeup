      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) =>
                onChange({ ...filters, keywords: e.target.value })
              }
        ...
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(v) =>
              onChange({ ...filters, qualification: v === "all" ? null : v })
            }
          >
            <SelectTrigger className="text-sm">
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Input
              ...
              value={
                filters.minExperience !== null
                  ? String(Number(filters.minExperience))
                  : ""
              }
              onChange={(e) =>
                onChange({
                  ...
                  minExperience: e.target.value
                    ? BigInt(Number.parseInt(e.target.value))
                    : null,
                })
              }
            />
            <Input
              ...
              value={
                filters.maxExperience !== null
                  ? String(Number(filters.maxExperience))
                  : ""
              }
              onChange={(e) =>
                onChange({
