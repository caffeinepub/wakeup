...
export default function JobPostingForm({
  ...
  const toggleItem = (
    field: "specializations" | "qualifications",
    value: string,
  ) => {
    setForm((prev) => ({
      ...prev,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      minExperience: BigInt(Number.parseInt(form.minExperience) || 0),
      maxExperience: BigInt(Number.parseInt(form.maxExperience) || 0),
      location: form.location.trim(),
      salaryMin: BigInt(Number.parseInt(form.salaryMin) || 0),
      salaryMax: BigInt(Number.parseInt(form.salaryMax) || 0),
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, minExperience: e.target.value }))
                }
                placeholder="0"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, maxExperience: e.target.value }))
                }
                placeholder="10"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g. 300000 (₹3,00,000)"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g. 700000 (₹7,00,000)"
              />
            </div>
          </div>
