          ...
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                <Badge variant="secondary" className="text-primary text-xs">{candidate.specialization}</Badge>
              ...
              <div className="flex flex-wrap gap-3 text-xs text-muted-foreground mb-2">
                ...
                <span className="flex items-center gap-1">
                  <Briefcase className="w-3 h-3" />{Number(candidate.yearsOfExperience)} yrs experience
                </span>
              ...
              {skillsList.length > 0 && (
                <div className="flex flex-wrap gap-1">
                  ...
                  {candidate.skills.split(',').filter(s => s.trim()).length > 4 && (
                    <span className="inline-block text-xs text-muted-foreground px-1 py-0.5">
                      +{candidate.skills.split(',').filter(s => s.trim()).length - 4} more
                    </span>
                  )}
                </div>
              )}
