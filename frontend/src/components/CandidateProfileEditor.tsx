        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={form.qualification} onValueChange={(v) => setForm(p => ({ ...p, qualification: v }))}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5">
              ...
              <Input type="number" min="0" value={form.yearsOfExperience} onChange={set('yearsOfExperience')} />
            </div>
            <div className="space-y-1.5">
              <Label>Current Salary (₹/year)</Label>
              <Input type="number" min="0" value={form.currentSalary} onChange={set('currentSalary')} />
            </div>
            <div className="space-y-1.5">
              <Label>Expected Salary (₹/year)</Label>
              <Input type="number" min="0" value={form.expectedSalary} onChange={set('expectedSalary')} />
            </div>
          </div>
          <div className="space-y-1.5">
