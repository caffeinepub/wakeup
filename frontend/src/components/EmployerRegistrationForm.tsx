...
export default function EmployerRegistrationForm({ onSuccess }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    industry: '', companySize: '', location: '', about: '', website: '',
  });
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Input value={form.companyName} onChange={set('companyName')} placeholder="Apollo Pharmacy" />
              {errors.companyName && <p className="text-destructive text-xs">{errors.companyName}</p>}
            </div>
            <div className="space-y-1.5">
              <Label>Contact Person Name *</Label>
              <Input value={form.contactName} onChange={set('contactName')} placeholder="Rahul Mehta" />
            ...
            <div className="space-y-1.5">
              ...
              <Input value={form.industry} onChange={set('industry')} placeholder="Healthcare / Pharmacy" />
              {errors.industry && <p className="text-destructive text-xs">{errors.industry}</p>}
            </div>
            <div className="space-y-1.5">
              <Label>Company Size *</Label>
              <Select value={form.companySize} onValueChange={(v) => { setForm(p => ({ ...p, companySize: v })); setErrors(p => ({ ...p, companySize: '' })); }}>
            ...
            <div className="space-y-1.5">
              ...
              <Input value={form.location} onChange={set('location')} placeholder="Mumbai, Maharashtra" />
          ...
          <div className="space-y-1.5">
            ...
            <Textarea value={form.about} onChange={set('about')} placeholder="Brief description of your company, culture, and what makes you a great employer..." rows={4} />
