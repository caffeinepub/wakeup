      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-start gap-3">
            ...
            <div>
              <DialogTitle className="font-display text-xl">{candidate.name}</DialogTitle>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <p className="text-sm text-foreground flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-muted-foreground" />{candidate.location}
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground uppercase tracking-wide font-medium">Experience</p>
              <p className="text-sm text-foreground flex items-center gap-1">
                <Briefcase className="w-3.5 h-3.5 text-muted-foreground" />{Number(candidate.yearsOfExperience)} years
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground uppercase tracking-wide font-medium">Current Salary</p>
              <p className="text-sm text-foreground flex items-center gap-1">
            ...
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground uppercase tracking-wide font-medium">Expected Salary</p>
              <p className="text-sm text-foreground flex items-center gap-1">
                <DollarSign className="w-3.5 h-3.5 text-muted-foreground" />
            ...
            <>
              ...
              <div className="flex items-center gap-2 p-3 bg-secondary rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-foreground">Resume Available</p>
                  <p className="text-xs text-muted-foreground">Candidate has uploaded a resume</p>
                </div>
                <a
