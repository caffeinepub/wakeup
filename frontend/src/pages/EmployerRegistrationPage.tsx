...
export default function EmployerRegistrationPage() {
  ...
  const { data: employerProfile, isLoading: employerLoading } = useGetMyEmployerProfile();
  ...
  return (
    <AuthGuard>
      ...
      <div className="container mx-auto px-4 py-10 max-w-2xl">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-bold text-foreground mb-2">Create Employer Profile</h1>
          <p className="text-muted-foreground">Set up your company profile to start posting jobs and sourcing pharmacists.</p>
        </div>
        {employerLoading ? (
